...
-- --------------------------------------------------
-- Date Created: 09/25/2024 15:01:02
...
GO
IF OBJECT_ID(N'[dbo].[FK_TGuildTGuildApply1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[GuildApplies] DROP CONSTRAINT [FK_TGuildTGuildApply1];
GO
IF OBJECT_ID(N'[dbo].[FK_TGuildTGuildMember1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[GuildMembers] DROP CONSTRAINT [FK_TGuildTGuildMember1];
GO
...
ALTER TABLE [dbo].[GuildApplies]
ADD CONSTRAINT [FK_TGuildTGuildApply1]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_TGuildTGuildApply1'
CREATE INDEX [IX_FK_TGuildTGuildApply1]
ON [dbo].[GuildApplies]
    ([Guild_Id]);
GO
...
ALTER TABLE [dbo].[GuildMembers]
ADD CONSTRAINT [FK_TGuildTGuildMember1]
    FOREIGN KEY ([Guild_Id])
    REFERENCES [dbo].[Guilds]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_TGuildTGuildMember1'
CREATE INDEX [IX_FK_TGuildTGuildMember1]
ON [dbo].[GuildMembers]
    ([Guild_Id]);
GO
