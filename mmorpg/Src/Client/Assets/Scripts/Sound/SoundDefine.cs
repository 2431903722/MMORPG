...
class SoundDefine
{
    ...
    public const string SFX_UI_Win_Open = "ui/sfx_ui_win_show";
    public const string SFX_UI_Win_Close = "ui/sfx_ui_win_close";

    public const string SFX_UI_CountDown = "ui/sfx_returnl";
}
